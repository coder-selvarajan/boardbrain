                ...
                ForEach(0..<rows, id: \.self) { row in
                    ForEach(0..<columns, id: \.self) { column in
                        ZStack {
                            ...
                            if highlightPossibleMoves, let gameState = gameState {
...
//    ChessboardView(
//                piece: .constant(ChessPiece(type: ChessPieceType.allCases.randomElement()!,
//                                               row: Int.random(in: 0..<8),
//                                               column: Int.random(in: 0..<8))),
//                   possibleMoves: .constant([]),
//                   showCoordinates: .constant(true), highlightPossibleMoves: .constant(false), 
//                   gameState: .constant(nil),
//                   pieceMovedTo: { value in
//                        print(value)
//                    })
