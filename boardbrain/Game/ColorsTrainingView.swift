    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                SimpleBoardView(showCoordinates: .constant(true), whiteSide: .constant(true), showSquareColors: .constant(false), showSquareBorders: .constant(true), highlightIndex: $targetIndex, squareClicked: nil)
                ...
                VStack(alignment: .center, spacing: 5) {
                    if gameStarted {
                        Text("Choose the right color for the highlighted square: ")
                            .font(.footnote)
...
//
            ...
            .navigationTitle("BoardBrain: Colors training")
